...
# adiciona inteiro na string
    mv t1, a1       # concatena inteiro
    addi t1, t1, 48 # passa para ascii
    sb t1, 7(a3)

# adiciona ponto na string
    li t1, 46       # concatena '.'
    sb t1, 8(a3)

# adiciona fracao na string
    mv t3, a2       # move fracao para temp
    li t2, 100      # divisor = 100
    div t3, t3, t2  # pega centena de a2
    addi t3, t3, 48 # passa para ascii
    sb t3, 9(a3)    # coloca na string
    
    mv t3, a2       # move fracao para temp
    li t2, 10       # divisor = 10
    div t3, t3, t2  # pega dezena de a2
    rem t3, t3, t2  # pega dezena de a2
    addi t3, t3, 48 # passa para ascii
    sb t3, 10(a3)   # coloca na string

    mv t3, a2       # move fracao para temp
    rem t3, t3, t2  # pega unidade de a2
    addi t3, t3, 48 # passa para ascii
    sb t3, 11(a3)   # coloca valor na string
